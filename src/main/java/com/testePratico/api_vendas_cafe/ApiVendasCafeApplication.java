package com.testePratico.api_vendas_cafe;
...
public class ApiVendasCafeApplication implements CommandLineRunner {

	@Autowired
	private ProdutoRepository produtoRepository;

	public static void main(String[] args) {
		SpringApplication.run(ApiVendasCafeApplication.class, args);
	}
